...
async def search_patients(medical_history:Optional[str]=None,prescriptions:Optional[str]=None,lab_results:Optional[str]=None):
    results = []
...
# async def pagenationation(offset:int=0,limit:int=5):
#     all_patients=len(patients_dict)
#     start= 
